...
<html>
    ...
    <body>
        ...
        <div id="show-modulo" class="content scaffold-show" role="main">
            ...
            <f:display bean="modulo" />
            <g:form resource="${this.modulo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.modulo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
