...
<html>
    ...
    <body>
        ...
        <div id="show-entidadFederativa" class="content scaffold-show" role="main">
            ...
            <f:display bean="entidadFederativa" />
            <g:form resource="${this.entidadFederativa}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.entidadFederativa}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
