...
<html>
    ...
    <body>
        ...
        <div id="show-asentamiento" class="content scaffold-show" role="main">
            ...
            <f:display bean="asentamiento" />
            <g:form resource="${this.asentamiento}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.asentamiento}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
