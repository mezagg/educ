...
<html>
    ...
    <body>
        ...
        <div id="show-tipoAsentamiento" class="content scaffold-show" role="main">
            ...
            <f:display bean="tipoAsentamiento" />
            <g:form resource="${this.tipoAsentamiento}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tipoAsentamiento}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
